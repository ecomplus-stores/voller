  ...
  if (router1) {
    const emitCheckout1 = (name) => {
      ...
      if (countQuantity < lessQuantity) {
       ...
       window.alert('Um dos produtos do estoque acabou! Você estará sendo direcionado para o carrinho para inserir mais itens para completar o pedido mínimo')
      }
    }
